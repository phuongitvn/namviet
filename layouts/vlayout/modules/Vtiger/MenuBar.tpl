			...
			<div class="menuBar row-fluid">
				...
				<div class="span9" style="overflow: hidden;">
					<ul class="nav modulesList">
						<li class="tabs">
							<a class="alignMiddle logocrmplus" href="/"><img src="{vimage_path('home.png')}" alt="{vtranslate('LBL_HOME',$moduleName)}" title="{vtranslate('LBL_HOME',$moduleName)}" /></a>
						</li>
										...
										<ul class="dropdown-menu pull-right">
											{foreach key=index item=obj from=$childLinks}
												...
												{else if $obj->getLabel() eq 'LBL_FEEDBACK'}
													<li>
														<a href="http://thongtinquanly.com/crmplus" target="_blank">{vtranslate($obj->getLabel(),$MODULE)}</a></li>
												{else}
