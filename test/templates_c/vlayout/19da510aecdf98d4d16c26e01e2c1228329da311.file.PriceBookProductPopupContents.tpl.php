<?php /* Smarty version Smarty-3.1.7, created on 2014-04-02 16:57:25
         compiled from "/var/www/html/CRMPlus/crmplus_ga/includes/runtime/../../layouts/vlayout/modules/Products/PriceBookProductPopupContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2106863816533c417518aa01-88844459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19da510aecdf98d4d16c26e01e2c1228329da311' => 
    array (
      0 => '/var/www/html/CRMPlus/crmplus_ga/includes/runtime/../../layouts/vlayout/modules/Products/PriceBookProductPopupContents.tpl',
      1 => 1389945509,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2106863816533c417518aa01-88844459',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_533c41752e02b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_533c41752e02b')) {function content_533c41752e02b($_smarty_tpl) {?>
...
" id="parentModule"><input type="hidden" value="PriceBook_Products_Popup_Js" id="popUpClassName"/><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><table class="table table-bordered listViewEntriesTable"><thead><tr class="listViewHeaders"><th class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
'/></div></td></tr><?php } ?></table><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTIRES_COUNT']->value=='0'){?><div class="row-fluid"><div class="emptyRecordsDiv"><?php echo vtranslate('LBL_NO',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_NAME']->value,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
 <?php echo vtranslate('LBL_FOUND',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
.</div></div><?php }?></div><div class="clearfix form-actions" style="background-color:#EEF6FE !important"><a class="cancelLink cursorPointer pull-right horizontalLeftSpacing"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a><button class="btn addButton select pull-right btn-primary"><i class="icon-plus icon-white"></i>&nbsp;<strong><?php echo vtranslate('LBL_ADD_TO_PRICEBOOKS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
